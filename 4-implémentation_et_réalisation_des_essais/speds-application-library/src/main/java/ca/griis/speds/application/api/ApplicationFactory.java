...
public interface ApplicationFactory {
   ...
   */
  ApplicationHost init(String parameters, ApplicationHostEvent consumer,
   ...
   *      S.O.
   */
  PresentationHost initPresentationHost(String parameters, PresentationHostEvent consumer);
}
