...
public interface PresentationFactory {
   ...
   *      S.O.
   */
  PresentationHost initHost(String parameters, PresentationHostEvent hostEventConsumer);
   ...
   *      S.O.
   */
  SessionHost initSessionHost(String parameters, SessionHostEvent hostEventConsumer);
}
