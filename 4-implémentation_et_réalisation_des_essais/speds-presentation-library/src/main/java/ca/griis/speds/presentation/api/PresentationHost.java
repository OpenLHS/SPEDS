 ...
 *
 * @brief @~french Implémentation de l'interface PresentationHost.
 * @brief @~english Implementation of the PresentationHost interface.
 */
 ...
 *
 * @brief @~french Définit les services d'un hôte de la couche présentation.
 * @par Details
 *      S.O.
 * @par Modèle
 *      S.O.
...
public interface PresentationHost {
   ...
   *      S.O.
   */
  CompletableFuture<Optional<String>> submitIdu(String idu) throws JsonProcessingException;
