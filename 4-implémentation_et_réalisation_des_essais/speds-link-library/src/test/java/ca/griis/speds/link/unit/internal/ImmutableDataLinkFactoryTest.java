...
public class ImmutableDataLinkFactoryTest implements HostEvent {
  ...
  void initWithHttpsProtocol() {
    ...
    // When
    ImmutableDataLinkHost dataLinkHost =
        (ImmutableDataLinkHost) factory.init(parametersJson, this);
  ...
  void initWithInvalidFormat() {
    ...
    ParameterException exception = assertThrows(ParameterException.class, () -> {
      factory.init(parametersJson, this);
    });
        ...
        """
            {
                "options": {
                  "speds.dl.protocol": "https",
                  "speds.dl.https.private.key": "INVALID-KEY",
                  "speds.dl.https.cert": "",
                  "speds.dl.https.server.host": "0.0.0.0",
                  "speds.dl.https.server.port": 8080
                }
        ...
        """
            {
                "options": {
                  "speds.dl.protocol": "https",
                  "speds.dl.https.private.key": "",
                  "speds.dl.https.cert": "INVALID-CERTIFICATE",
                  "speds.dl.https.server.host": "0.0.0.0",
                  "speds.dl.https.server.port": 8080
                }
            }
        ...
        """
            {
                "options": {
                  ...
                  "speds.dl.https.client.cert.trustmanager.mode": "standard"
                }
            }
            """;

    // When
    ImmutableDataLinkHost dataLinkHost = (ImmutableDataLinkHost) factory.init(parametersJson, this);
