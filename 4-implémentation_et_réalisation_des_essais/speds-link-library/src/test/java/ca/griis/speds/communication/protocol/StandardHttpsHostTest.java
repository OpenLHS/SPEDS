...
public class StandardHttpsHostTest implements ProtocolHostEvent {
  ...
  public void init() throws Exception {
    ...
    final SslContext sslContextClient =
        SslContextBuilder.forClient().trustManager(rootCert).build();
    final SslContextBuilder sslContextBuilderServer =
        SslContextBuilder.forServer(privateKey, certificate).trustManager(rootCert);
