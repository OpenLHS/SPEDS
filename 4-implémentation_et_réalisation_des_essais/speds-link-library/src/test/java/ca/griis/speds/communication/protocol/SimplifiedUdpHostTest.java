...
public class SimplifiedUdpHostTest implements ProtocolHostEvent {
  private ProtocolUdpHost server;
  private ProtocolUdpHost client;
  private ObjectMapper objectMapper = new ObjectMapper();
  private LinkedBlockingQueue<ProtocolIdu> idus = new LinkedBlockingQueue<>();

  @BeforeEach
  public void init() {
    server = new ProtocolUdpHost(objectMapper, "localhost", 8080, this);
    client = new ProtocolUdpHost(objectMapper, "localhost", 8081, this);
  }
