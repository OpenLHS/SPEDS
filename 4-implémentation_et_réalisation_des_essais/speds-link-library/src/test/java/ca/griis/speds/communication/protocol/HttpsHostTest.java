...
public class HttpsHostTest {
  ...
  public void setUp() {
    ...
    host = new ProtocolHttpHost(objectMapperSpy, "localhost", 8080, sslContextMock, sslContextMock,
        1048576, hostEvent);
  }
  ...
  public void testRequest_JsonProcessingException() throws JsonProcessingException {
    ProtocolIdu pdu = new ProtocolIdu("http://oneuri", "a message");
