 ...
 *
 * @brief @~french Implémentation de l'interface HostEvent.
 * @brief @~english Implementation of the HostEvent interface.
 */
 ...
 *
 * @brief @~french Définit les événements générés par un hôte de la couche de protocole et transmis
 *        l'utilisateur de cette couche.
 * @par Details
 *      S.O.
 * @par Modèle
 *      S.O.
