...
public class EfficientX25519ProviderTest {
  ...
  public void setUp() throws Exception {
    ...
    byte[] derivedKeyForAlice =
        aliceEcdhProvider.deriveSecure128BitsKey(sharedKeyForAlice, alicePublicKey, bobPublicKey);
    ...
    byte[] derivedKeyFoBob =
        bobEcdhProvider.deriveSecure128BitsKey(sharedKeyForBob, bobPublicKey, alicePublicKey);
  ...
  @Test
  public void encryptedAesMessageIntercepted() throws Exception {
    CsprngSpec csprngSpec = new EfficientCsprngSpec();
    ...
    byte[] derivedKeyForEve =
        ecdhProviderEve.deriveSecure128BitsKey(sharedKeyForEve, evePublicKey, alicePublicKey);
