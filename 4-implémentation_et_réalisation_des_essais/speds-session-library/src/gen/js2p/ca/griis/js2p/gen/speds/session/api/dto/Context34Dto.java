...
public class Context34Dto implements Serializable
{
    ...
    @NotNull
    private Context34Dto.ServicePrimitive servicePrimitive;
    /**
    ...
    private final static long serialVersionUID = -1314721356674700602L;
     ...
     *     The service primitive used to communicate among the layers.
     */
    public Context34Dto(String sourceCode, String destinationCode, String sourceIri, Context34Dto.Service service, Context34Dto.ServicePrimitive servicePrimitive, String destinationIri, Object options) {
        super();
     ...
     */
    @JsonProperty("service_primitive")
    public Context34Dto.ServicePrimitive getServicePrimitive() {
    ...
    public enum ServicePrimitive {
        ...
        private final String value;
        private final static Map<String, Context34Dto.ServicePrimitive> CONSTANTS = new HashMap<String, Context34Dto.ServicePrimitive>();

        static {
            for (Context34Dto.ServicePrimitive c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static Context34Dto.ServicePrimitive fromValue(String value) {
            Context34Dto.ServicePrimitive constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
