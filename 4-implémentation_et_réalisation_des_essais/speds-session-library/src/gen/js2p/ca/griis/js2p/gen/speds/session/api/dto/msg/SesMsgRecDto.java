...
/**
 * SesMsgRec (2026-01-15T10:20:00-0500)
 * <p>
 * 
 * 
 */
...
public class SesMsgRecDto implements Serializable
{
    ...
    private final static long serialVersionUID = -1664448923023534160L;
     ...
     * @param content
     *     The content to be sent as a response, encoded into base64.
     */
    public SesMsgRecDto(String content, UUID session) {
        super();
    ...
    public String toString() {
        ...
        sb.append(SesMsgRecDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("content");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SesMsgRecDto) == false) {
            return false;
        }
        SesMsgRecDto rhs = ((SesMsgRecDto) other);
