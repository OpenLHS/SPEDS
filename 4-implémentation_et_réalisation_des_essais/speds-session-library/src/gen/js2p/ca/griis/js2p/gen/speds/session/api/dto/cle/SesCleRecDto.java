...
/**
 * SesCleRec (2026-01-15T10:20:00-0500)
 * <p>
 * 
 * 
 */
...
public class SesCleRecDto implements Serializable
{
    ...
    private final static long serialVersionUID = -2140912027115451178L;
     ...
     *     The session token.
     * @param content
     *     Encryption of the session token by the SDEK key, encoded into Base64.
     */
    public SesCleRecDto(String content, UUID session) {
        super();
    ...
    public String toString() {
        ...
        sb.append(SesCleRecDto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("content");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SesCleRecDto) == false) {
            return false;
        }
        SesCleRecDto rhs = ((SesCleRecDto) other);
