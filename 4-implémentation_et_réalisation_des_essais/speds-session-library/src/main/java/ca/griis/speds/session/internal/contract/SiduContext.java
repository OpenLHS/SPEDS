...
public class SiduContext extends Context34Dto {
  ...
  public SiduContext(String sourceCode, String destinationCode, String sourceIri,
      Context34Dto.Service service, Context34Dto.ServicePrimitive servicePrimitive,
      String destinationIri, Object options) {
    super(sourceCode, destinationCode, sourceIri, service, servicePrimitive, destinationIri,
        options);
  }
}
