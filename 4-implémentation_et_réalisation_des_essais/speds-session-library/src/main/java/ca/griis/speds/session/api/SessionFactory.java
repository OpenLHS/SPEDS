...
public interface SessionFactory {
   ...
   * @param hostEventConsumer Instance de classe qui reçoit les événements venant de la couche
   *        session.
   ...
   *      S.O.
   */
  SessionHost initHost(String parameters, SessionHostEvent hostEventConsumer);
   ...
   *      S.O.
   */
  TransportHost initTransportHost(String parameters, TransportHostEvent hostEventConsumer);
}
