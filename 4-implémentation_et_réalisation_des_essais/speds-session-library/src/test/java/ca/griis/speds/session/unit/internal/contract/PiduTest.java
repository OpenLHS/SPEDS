...
public class PiduTest {
  ...
  public void makePidu() {
    Context23Dto context23Dto = new PiduContext("a", "a", "a", "a", Context23Dto.Service.TRANSFER,
  ...
  public void testPiduSerializationDeserialization() throws Exception {
    // given
    PiduContext piduContext = new PiduContext("a", "a", "a", "a", Context23Dto.Service.TRANSFER,
        Context23Dto.ServicePrimitive.REQUEST, false);
