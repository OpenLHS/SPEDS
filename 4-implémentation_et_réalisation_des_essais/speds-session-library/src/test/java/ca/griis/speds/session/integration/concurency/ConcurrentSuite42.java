...
//
// @Mock
// private ImmutableTransportHost partenaire1TransportHost;
//
// @Mock
// private ImmutableTransportHost partenaire2TransportHost;
//
// @Mock
...
// private KeyPair part1Keys;
// private KeyPair part2Keys;
//
...
// .thenReturn(factory.construct("https://localhost/destination1"));
// when(projectService.getEntityIri(pgaId, piduContext2.getDestinationCode()))
// .thenReturn(factory.construct("https://localhost/destination2"));
// when(projectService.getEntityPublicKey(pgaId, piduContext1.getDestinationCode()))
// .thenReturn(this.part1Keys.getPublic());
// when(projectService.getEntityPublicKey(pgaId, piduContext2.getDestinationCode()))
// .thenReturn(this.part2Keys.getPublic());
...
//
// initiatrice1TransportHost.notifyIdu(initiatriceResponse.poll());
//
...
// return null;
// }).when(partenaire1TransportHost).submitIdu(any());
// partenaire1TransportHost.notifyIdu(initiatrice1Request.poll());
//
...
// initiatriceResponse.add(serialMsg);
// return null;
// }).when(partenaire2TransportHost).submitIdu(any());
//
// partenaire2TransportHost.notifyIdu(initiatrice2Request.poll());
//
