package ca.griis.speds.integration.session;
...
public class SpedsSessionTest implements SessionHostEvent {
  ...
  public void nominal() throws Exception {
    ...
    String peerReceivedIdu = idus.poll(10, TimeUnit.SECONDS);
    ...
    peerSessions.poll(10, TimeUnit.SECONDS);
    initiatorSessions.poll(10, TimeUnit.SECONDS);
  }
  ...
  @Override
  public void notifyException(Exception arg0) {}
}
