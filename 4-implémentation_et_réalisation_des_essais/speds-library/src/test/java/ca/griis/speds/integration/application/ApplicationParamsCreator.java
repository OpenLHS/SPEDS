...
public class ApplicationParamsCreator {
  private static final GriisLogger logger = getLogger(ApplicationParamsCreator.class);
  ...
  public static Map<String, Object> createSourceParams() throws CertificateEncodingException {
    ...
    options.put("speds.app.version", "7");
    options.put("speds.app.reference", "https://reference.iri/speds");
  ...
  public static ProjectService createProjectService(String pgaId, String sourceCode,
    ...
    when(projectService.checkPlanActivity(pgaId)).thenReturn(true);
