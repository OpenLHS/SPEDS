...
public interface TransportFactory {
   ...
   *      S.O.
   */
  TransportHost initHost(String parameters, TransportHostEvent hostEventConsumer);
   ...
   *      S.O.
   */
  NetworkHost initNetworkHost(String parameters, NetworkHostEvent hostEventConsumer);
}
