...
public class Speds45Dto implements Serializable
{
    ...
    private final static long serialVersionUID = 6602000331205704277L;
     ...
     */
    public Speds45Dto(String number, String reference) {
        super();
        this.number = number;
    ...
    public String toString() {
        ...
        sb.append(Speds45Dto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("number");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Speds45Dto) == false) {
            return false;
        }
        Speds45Dto rhs = ((Speds45Dto) other);
