...
public class Context56Dto implements Serializable
{
    ...
    @NotNull
    private Context56Dto.ServicePrimitive servicePrimitive;
    /**
    ...
    private final static long serialVersionUID = 279108720501879168L;
     ...
     *     The service primitive used to communicate among the layers.
     */
    public Context56Dto(String destinationIri, String service, Context56Dto.ServicePrimitive servicePrimitive, Object options) {
        super();
     ...
     *     The service primitive used to communicate among the layers.
     */
    public Context56Dto(String destinationIri, Context56Dto.ServicePrimitive servicePrimitive, Object options) {
        super();
        this.destinationIri = destinationIri;
        this.servicePrimitive = servicePrimitive;
        this.options = options;
     ...
     */
    @JsonProperty("service_primitive")
    public Context56Dto.ServicePrimitive getServicePrimitive() {
    ...
    public String toString() {
        ...
        sb.append(Context56Dto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Context56Dto) == false) {
            return false;
        }
        Context56Dto rhs = ((Context56Dto) other);
    ...
    public enum ServicePrimitive {
        ...
        private final static Map<String, Context56Dto.ServicePrimitive> CONSTANTS = new HashMap<String, Context56Dto.ServicePrimitive>();

        static {
            for (Context56Dto.ServicePrimitive c: values()) {
        ...
        @JsonCreator
        public static Context56Dto.ServicePrimitive fromValue(String value) {
            Context56Dto.ServicePrimitive constant = CONSTANTS.get(value);
            if (constant == null) {
