...
public class Context45Dto implements Serializable
{
    ...
    @NotNull
    private Context45Dto.ServicePrimitive servicePrimitive;
    /**
    ...
    private final static long serialVersionUID = 1043977869024793142L;
     ...
     *     The service primitive used to communicate among the layers.
     */
    public Context45Dto(String sourceIri, String destinationIri, String service, Context45Dto.ServicePrimitive servicePrimitive, Object options) {
        super();
     ...
     *     The service primitive used to communicate among the layers.
     */
    public Context45Dto(String sourceIri, String destinationIri, Context45Dto.ServicePrimitive servicePrimitive, Object options) {
        super();
        this.sourceIri = sourceIri;
        this.destinationIri = destinationIri;
        this.servicePrimitive = servicePrimitive;
     ...
     */
    @JsonProperty("service_primitive")
    public Context45Dto.ServicePrimitive getServicePrimitive() {
    ...
    public enum ServicePrimitive {
        ...
        private final static Map<String, Context45Dto.ServicePrimitive> CONSTANTS = new HashMap<String, Context45Dto.ServicePrimitive>();

        static {
            for (Context45Dto.ServicePrimitive c: values()) {
        ...
        @JsonCreator
        public static Context45Dto.ServicePrimitive fromValue(String value) {
            Context45Dto.ServicePrimitive constant = CONSTANTS.get(value);
            if (constant == null) {
