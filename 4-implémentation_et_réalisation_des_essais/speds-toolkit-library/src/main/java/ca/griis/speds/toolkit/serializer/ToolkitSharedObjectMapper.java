 ...
 *
 * @brief @~french Contient la description de la classe ToolkitSharedObjectMapper.
 * @brief @~english Contains description of ToolkitSharedObjectMapper class.
 */

package ca.griis.speds.toolkit.serializer;
 ...
 *      S.O.
 */
public class ToolkitSharedObjectMapper {
  private ObjectMapper mapper = new ObjectMapper();

  protected ToolkitSharedObjectMapper() {
    mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, true);
  }

  private static class LazyHolder {
    static final ToolkitSharedObjectMapper instance = new ToolkitSharedObjectMapper();
  }

  public static ToolkitSharedObjectMapper getInstance() {
