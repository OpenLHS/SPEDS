 ...
 *
 * @brief @~french Implémentation de la classe ExpandedSidu.
 * @brief @~english Implementation of the ExpandedSidu class.
 */
 ...
 *
 * @brief @~french Implémentation de ExpandedSidu
 * @par Details
 *      S.O.
 * @par Modèle
 *      S.O.
 ...
 *      S.O.
 */
public record ExpandedSidu (Sidu sidu, Spdu spdu, MsgType msgType) {
}
