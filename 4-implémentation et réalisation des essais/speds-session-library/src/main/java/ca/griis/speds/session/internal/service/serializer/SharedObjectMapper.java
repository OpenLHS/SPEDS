 ...
 *
 * @brief @~french Implémentation de la classe SharedObjectMapper.
 * @brief @~english Implementation of the class SharedObjectMapper.
 */

package ca.griis.speds.session.internal.service.serializer;
 ...
 *
 * @par Historique
 *      2020-01-07 [MBJ] - Première ébauche.
 *
