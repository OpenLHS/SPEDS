 ...
 *
 * @brief @~french Implémentation de l'interface TransportServer.
 * @brief @~english Implementation of the TransportServer interface.
 */
 ...
 *
 * @brief @~french Offre les services d'un serveur de la couche transport.
 * @par Details
 *      S.O.
 * @par Modèle
 *      S.O.
