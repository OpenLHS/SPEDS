...
@Disabled
public class AppLinkMemoryLeakIT {
  ...
  @Test
  public void appLinkMemoryLeakTest() throws IOException {
        ...
        for (int j = 0; j < MESSAGES_PER_ITERATION; j++) {
          ...
          InterfaceDataUnit12Dto receivedIdu12Dto =
              testUtil.transformIdu56ToIdu12(receivedIdu56Dto, idu12Dto.getContext().getPga(),
                  idu12Dto.getContext().getSourceCode(),
                  idu12Dto.getContext().getDestinationCode());
