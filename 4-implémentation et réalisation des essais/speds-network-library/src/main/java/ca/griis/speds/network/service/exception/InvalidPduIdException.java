 ...
 *
 * @brief @~french Implémentation de la classe InvalidPduIdException.
 * @brief @~english InvalidPduIdException class implementation.
 */
 ...
 *
 * @brief @~french Erreur soulevée lorsque l'identifiant de la réponse ne correspond pas à
 *        l'identifiant d'une requête précédemment envoyée.
 * @par Details
 *      S.O.
 * @par Modèle
 *      S.O.
...
public class InvalidPduIdException extends RuntimeException {
  private static final GriisLogger logger = getLogger(InvalidPduIdException.class);
