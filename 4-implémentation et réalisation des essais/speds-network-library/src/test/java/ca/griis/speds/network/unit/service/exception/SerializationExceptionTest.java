...
public class SerializationExceptionTest {
  ...
  public void messageConstructorTest() throws Exception {
    ...
    final SerializationException exception = new SerializationException(message);
  ...
  public void messageCauseConstructorTest() throws Exception {
    ...
    final SerializationException exception = new SerializationException(message, cause);
