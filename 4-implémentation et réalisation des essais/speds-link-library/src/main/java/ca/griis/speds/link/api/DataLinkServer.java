 ...
 *
 * @brief @~french Implémentation de l'interface DataLinkServer.
 ...
 *
 * @brief @~french Définit les services d'un serveur de la couche liaison.
 * @par Details
 *      S.O.
 * @par Modèle
 *      S.O.
 ...
 *      S.O.
 */
public interface DataLinkServer {
  /**
